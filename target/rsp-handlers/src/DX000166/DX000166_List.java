...
public class DX000166_List extends TxtRspHandler {
			...
			try {
					...
					if (table_point.getAttribute("class").equals(
						...
						for (int i = 1; i < tr_list.getLength(); i++) {
							...
							Element a_date = (Element) td_detail
									.getElementsByTagName("td").item(4);
				...
				if(divList!=null)
				{
					for(int i=0;i<divList.getLength();i++)
					{
						...
						if("LsitInfoFrameBtmBg".equals(div.getAttribute("class")))
						{
	...
	public static void main(String[] args) {
		DX000166_List handler = new DX000166_List();
		// utf-8 gbk gb2312
		try {
			String originRspContent = IO.deserializeString(
					"internetware/DX000166/apis/DX000166_List/SampleResponse",
					"UTF-8");
